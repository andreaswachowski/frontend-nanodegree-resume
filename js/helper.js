...
var HTMLschoolDescription = '<br><p class="education-entry-description">%data%</p>';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    // To avoid duplicates in the locations, we will use an object as an
    // assocative array and later convert the locatino list to an array.
    var uniqueLocations = {};

    // adds the single location property from bio to the locations object
    uniqueLocations[bio.contacts.location] = 1;

    // iterates through school locations and appends each location to
    // the locations array
    for (var school in education.schools) {
      // locations.push(education.schools[school].location);
      uniqueLocations[education.schools[school].location] = 1;
    }

    // iterates through work locations and appends each location to
    // the locations array
    for (var job in work.jobs) {
      uniqueLocations[work.jobs[job].location] = 1;
    }
